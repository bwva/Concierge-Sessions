...
can_ok('Concierge::Sessions::Base',
    qw(new create_session get_session_info update_session delete_session delete_user_sessions cleanup_expired generate_session_id));

# Backend interface methods for SQLite
can_ok('Concierge::Sessions::SQLite',
    qw(new create_session get_session_info update_session delete_session delete_user_sessions cleanup_expired));
